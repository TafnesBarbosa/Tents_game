...
# for i in range(1000):
    # tents_game = TentsGame(10, seed=None, show_before_remove_tents=False)
# tents_game.show()
    # history = []
# # # for i in range(100):
...
# tents_game = TentsGame(17, seed=26, show_before_remove_tents=False)
#     tic = time.time()
# tents_game = TentsGame(8, generate=False, trees_x=[0,2,7,3,5,1,3,4,0,5,7,2], trees_y=[0,1,1,2,3,4,4,5,6,6,6,7], tips_x=[2,1,0,4,0,2,1,2], tips_y=[1,2,0,2,1,2,1,3])
